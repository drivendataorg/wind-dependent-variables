...
parser.add_str('--data_tfrec_dir',    default='../../data/data-tfrec-frames003-step009-ind', help='Data directory containig TFRecord files')
...
parser.add_int('--dim',               default=384,           help='Image size in pixels. This final size which will be passed to a model')
parser.add_int('--dim_before_aug',    default=384,           help='Image size in pixels before augmentation. This may differ form final size passed to a model')
...
parser.add_str('--weights',           default='imagenet21k+imagenet2012',    help='Name of pretrained weights. E.g.: imagenet, noisy-student, imagenet21k+imagenet2012, imagenet21k, or None')
