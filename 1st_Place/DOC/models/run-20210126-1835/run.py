...
parser.add_float('--label_smoothing', default=0.0,           help='Label smoothing. Apllicable to classification task only')
...
class RMSECLAS(tf.keras.metrics.RootMeanSquaredError):
    ...
    def update_state(self, y_true, y_pred, sample_weight=None):
        super(RMSECLAS, self).update_state(y_true, tf.argmax(y_pred, axis=1), sample_weight=sample_weight)
    #
    def result(self):
