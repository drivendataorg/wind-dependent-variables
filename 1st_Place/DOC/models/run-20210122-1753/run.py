...
def parse_example(example_proto):
    ...
    image = tf.map_fn(fn, d['image'], dtype=tf.uint8)                                   # (48, 366, 366, 1)
    image = tf.squeeze(image)                                                           # (48, 366, 366)
    image = tf.reshape(image, [args.volume_size, args.n_channels, args.dim, args.dim])  # (16, 3, 366, 366)
    image = tf.transpose(image, perm=[0, 2, 3, 1])                                      # (16, 366, 366, 3)
    #
