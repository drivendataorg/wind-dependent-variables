...
parser.add_str('--data_tfrec_dir',    default='../../data/data-tfrec-frames048-step001-lstm', help='Data directory containig TFRecord files')
...
parser.add_int('--n_channels_total',  default=48,            help='Total number of monochrome frames to read from TFRecord. Applicable to architectures trained on sequences (volumes) of 3-channel images')
parser.add_int('--volume_size',       default=16,             help='Number of 3-channel images in a sequence (volume)')
...
def init_model(print_summary=True):
    ...
    effnet = args.model_func(input_shape=(args.dim, 
                                          args.dim, 
                                          args.n_channels),
