...
MODEL_TYPE = 'L1A'
MODEL_VERSION = 'B'
TRAINING_VERSION = '2'  # se_resnet152 - A04
...
BASEMODEL_FEATURES = {
    'se_resnet152': (2048, lambda model: nn.Sequential(*list(model.children())[:-2], nn.AdaptiveAvgPool2d(output_size=(1, 1)))),
}
...
def get_learner(nb_classes, args=ARGS):
    ...
    criterion = pytorch_metrics.MSELoss()
