...
MODEL_TYPE = 'L1A'
MODEL_VERSION = 'B'
TRAINING_VERSION = '1'  # resnext101_64x4d - A02
...
# Model
args.update({
    'basemodel_name': 'resnext101_64x4d',
...
BASEMODEL_FEATURES = {
    'resnext101_64x4d': (2048, lambda model: nn.Sequential(*list(model.children())[:-2], nn.AdaptiveAvgPool2d(output_size=(1, 1)))),
}
