...
sub.to_csv('lstm_dain_%dts_after_%s_and_img_feat_%s.csv'%(time_steps, out_path_arr[path_idx], img_out_path_arr[img_path_idx]), index = False)
np.save('lstm_dain_%dts_after_%s_and_img_feat_%s'%(time_steps, out_path_arr[path_idx], img_out_path_arr[img_path_idx]), test_final_pred)
np.save('lstm_dain_%dts_after_%s_and_img_feat_%s_val'%(time_steps, out_path_arr[path_idx], img_out_path_arr[img_path_idx]), val_pred)
