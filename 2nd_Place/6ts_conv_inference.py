...
parser.add_argument('--ch_arrangement', help='input channel arrangement [0-5]', required=True, type=int)
...
if args.ch_arrangement == 0:
    ch_arr = [0,1,2]
elif args.ch_arrangement == 1:
    ch_arr = [0,2,1]
elif args.ch_arrangement == 2:
    ch_arr = [1,0,2]
elif args.ch_arrangement == 3:
    ch_arr = [1,2,0]
elif args.ch_arrangement == 4:
    ch_arr = [2,0,1]
else:
    ch_arr = [2,1,0]
...
if args.ch_arrangement == 0:
    ...
    path = '6ts_imgs_time_aug_resnet50_models_%d%d%d'%(ch_arr[0], ch_arr[1], ch_arr[2])
...
test_imgs = np.load('6ts_test_imgs_224.npy')
test_imgs_ids = np.load('6ts_test_imgs_ids.npy')
...
sub.to_csv('6ts_imgs_res50_group_5folds_aug_time_%d%d%d.csv'%(ch_arr[0], ch_arr[1], ch_arr[2]), index = False)
