...
path = '6ts_6space_imgs_time_aug_resnet50_models'
os.makedirs(path)
...
test_imgs = np.load('6ts_6space_test_imgs_224.npy')
test_imgs_ids = np.load('6ts_6space_test_imgs_ids.npy')
...
sub.to_csv('6ts_6space_imgs_res50_group_5folds_aug_time.csv', index = False)#_%d%d%d.csv'%(ch_arr[0], ch_arr[1], ch_arr[2]), index = False)
