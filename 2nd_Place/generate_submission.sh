...
echo "Training first stage CNN models"
...
echo "RESNET18 with 12 time step images"
...
echo "RESNET50 with 6 time step images, 2 space"
...
echo "RESNET50 with 6 time step images, 3 space"
...
echo "RESNET50 with 6 time step images, 4 space"
...
echo "RESNET50 with 6 time step images, 5 space"
...
echo "RESNET50 with 6 time step images, 6 space"
...
# Third stage model
echo "Third stage ensemble model"
